...
import { useNavigation } from '@react-navigation/native';   // Função de navegação
import { RectButton, TextInput } from 'react-native-gesture-handler';  //Rec - botão retangular
      ...
      >
        ...
        <View style={styles.footer}>
          ...
          <TextInput style={styles.input} placeholder="Digite a Cidade" 
            value={city} onChangeText={setCity} autoCorrect={false}
          />
